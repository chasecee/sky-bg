...
export WEBCAM_URL OUTPUT_DIR HISTORY_DIR LOG_DIR LOG_LEVEL RAW_CROP_TOP CANVAS_FIT CANVAS_ANCHOR BLUR_RADIUS COLOR_SATURATION COLOR_BRIGHTNESS BLEND_WEIGHTS CHANNEL_SHIFT CHANNEL_SHIFT_ANGLE
